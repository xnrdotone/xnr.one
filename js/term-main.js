...
var main = (function () {
    ...
    var configs = (function () {
        ...
        Singleton.defaultOptions = {
            ...
            welcome: "Welcome to xnr.one! This is the insite terminal, you can use this to quickly navigate around the site! Press the tab key to list available commands.",
    ...
    var files = (function () {
        ...
        Singleton.defaultOptions = {
            "about": "Welcome to xnr.one interactive terminal! The terminal is under heavy development at the moment and is not really functional. My aim is to make the whole site navigatable from the terminal unfortunalelly I am no javascript wizard...",
            "contact": "xnrdotone@gmail.com",
        };
        return {
            getInstance: function (options) {
                instance === void 0 && (instance = new Singleton(options));
    ...
    var cmds = {
        ...
        // WHOAMI: { value: "", help: configs.getInstance().whoami_help },
        // DATE: { value: "", help: configs.getInstance().date_help },
        HELP: { value: "help", help: configs.getInstance().help_help },
        CLEAR: { value: "clear", help: configs.getInstance().clear_help },
        // REBOOT: { value: "", help: configs.getInstance().reboot_help },
        CD: { value: "cd", help: configs.getInstance().cd_help },
        // MV: { value: "", help: configs.getInstance().mv_help },
        // RM: { value: "", help: configs.getInstance().rm_help },
        // RMDIR: { value: "", help: configs.getInstance().rmdir_help },
        // TOUCH: { value: "", help: configs.getInstance().touch_help },
        // SUDO: { value: "", help: configs.getInstance().sudo_help }
    };
